...
export default function EventGrid({ events }: EventGridProps) {
  ...
  return (
    <section id="eventos" className="mx-auto max-w-7xl px-4 py-12">
      ...
      <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 min-h-[900px]">
      ...
      {totalPages > 1 && (
        <div className="mt-10 flex items-center justify-center gap-2">
          <button
            ...
            disabled={page === 1}
            className="flex h-10 w-10 items-center justify-center rounded-lg border border-border bg-card text-foreground transition-colors hover:bg-secondary disabled:opacity-40 disabled:cursor-not-allowed"
