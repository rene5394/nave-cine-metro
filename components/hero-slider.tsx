    ...
    <section className="relative h-[70vh] min-h-[500px] w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full items-end">
        <div className="mx-auto w-full max-w-7xl px-4 pb-12 md:pb-16">
          ...
          <p className="mb-5 max-w-xl text-base leading-relaxed text-white/90 drop-shadow md:text-lg">
            {event.description}
          </p>
      ...
      <div className="absolute bottom-12 right-4 z-20 flex items-center gap-2 md:right-8">
        <button
          type="button"
          onClick={prev}
